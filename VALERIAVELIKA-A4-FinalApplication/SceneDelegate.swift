...
//            print("App handled url: \(urlContext.url)")
...
//        if let scheme = url.scheme, scheme == "edu.monash.fit3178", let viewname = url.host {
...
//                        let forgottenPassWordViewController = storyboard.instantiateViewController(withIdentifier:
//    "forgottenPasswordVC") as! ForgottenPasswordViewController
//
//                        forgottenPassWordViewController.emailAddress = email
